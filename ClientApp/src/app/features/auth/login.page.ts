          ...
          <fieldset [disabled]="store.pending()" class="space-y-4">
            ...
            <div>
              ...
              <div class="relative">
                <input
                  ...
                  class="block w-full rounded-md border border-slate-300 dark:border-slate-700 px-3 py-2 pr-20 text-slate-900 dark:text-slate-100 shadow-sm focus:border-slate-900 dark:focus:border-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-900 dark:focus:ring-slate-100 dark:bg-slate-800"
                />
                <button
                  type="button"
            ...
            <label class="flex items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
              <input
                ...
                class="h-4 w-4 rounded border-slate-300 dark:border-slate-700 text-slate-900 dark:text-slate-100 focus:ring-slate-900 dark:focus:ring-slate-100"
              />
